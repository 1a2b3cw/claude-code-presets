...
| N6 | in_progress | 变更影响与完整性 | C6 | A4,A5 | 用户体验问题可以精准修改且不破坏整体 | 是 | 定位问题归属，生成影响范围、同步项和完整性验证 | P0 | XL | N3,N4,N5 | 体验变化能追踪到相关规划、代码、测试和文档 | 影响关系依赖 AI 自觉维护 | 2026-07-11 |
...
- [ ] N6 变更影响与完整性 - in_progress - 最近更新：2026-07-11
