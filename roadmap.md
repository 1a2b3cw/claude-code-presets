...
| N3 | in_progress | 架构主干 | C3 | A3 | 局部功能不会各自形成孤立设计 | 是 | 把产品能力映射为模块、职责、接口、依赖、数据流和安全边界，并定义架构演进规则 | P0 | XL | N2 | 功能和架构变更都能定位影响、迁移路径及兼容风险 | 过早固化实现或抽象过度 | 2026-07-11 |
...
- [ ] N3 架构主干 - in_progress - 最近更新：2026-07-11
